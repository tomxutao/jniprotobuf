    ...
    switch (tag >> 3) {
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 122)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_string_value(), ptr, ctx, "proto_util_converter.testing.DefaultValueTest.string_value");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
