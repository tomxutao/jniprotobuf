    ...
    switch (tag >> 3) {
      ...
      case 17:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 138)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_test_aliasing(), ptr, ctx, "protobuf_unittest.TestMessageSetExtension1.test_aliasing");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
    ...
    switch (tag >> 3) {
      ...
      case 25:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 202)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_str(), ptr, ctx, "protobuf_unittest.TestMessageSetExtension2.str");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
